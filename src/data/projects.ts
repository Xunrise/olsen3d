...
export const modelProjects: Project[] = [
  {
    ...
    images: ["/3d prints/latch/CAD top.png", "/3d prints/latch/CAD bottom.png", "/3d prints/latch/male.png", "/3d prints/latch/female.png"],
  }
];
...
export const iktProjects: Project[] = [
  {
    ...
    description: "Built a custom pc, recommended parts, etc using this and that part",
...
export const printProjects: Project[] = [
  {
    ...
    description: "3D Printed a replacement door handle for xyz bobil, saving xyz in costs for the customer. Printed in PLA, took 1 day",
